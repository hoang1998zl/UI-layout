    ...
    <Router>
      <div className="App">
        <nav style={{ display: "flex", flexDirection: "column" }}>
          <Link to="/UI03">UI03</Link>
          <Link to="/UI04">UI04</Link>
          <Link to="/UI05">UI05</Link>
          <Link to="/UI06">UI06</Link>
          <Link to="/UI07">UI07</Link>
          <Link to="/UI08">UI08</Link>
          <Link to="/UI09">UI09</Link>
          <Link to="/UI11">UI11</Link>
          <Link to="/UI12">UI12</Link>
          <Link to="/UI13">UI13</Link>
          <Link to="/UI14">UI14</Link>
          <Link to="/UI16">UI16</Link>
          <Link to="/UI17">UI17</Link>
          <Link to="/UI18">UI18</Link>
          <Link to="/UI19">UI19</Link>
        </nav>
